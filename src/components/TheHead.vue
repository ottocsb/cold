...
<template>
  ...
  <Transition name="slide-left">
    <div v-if="showMenu" class="menu-drawer" fixed  w-full h-full bg="white" z="999" overflow-hidden  pt="20px">
      ...
      <div w-full mt="20" px="30px">
        <div flex class="block" w="70"  b-rd="10px!" b="solid 1px #FFE7E7E7" bg="#faf8fa"  >
          <div flex w-full flex-wrap  @click="() => { showOption = !showOption }" style="align-items: center;">
            <img src="/PC/language.png" alt="language" h="22px" w="22px" ml="20px">
          <div v-on-click-outside="() => { showOption = false }"
          ...
          >
            ...
            <div v-if="showOption" top="15" w-full  flex-wrap flex-col>
              <div pl="60px"
                v-for="(item, index) in Language"
                :key="item.name"
